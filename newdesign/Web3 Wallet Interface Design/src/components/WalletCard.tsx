    ...
    >
      ...
      <div className="relative z-10 w-full h-full flex flex-col justify-between p-6 md:p-8">
        ...
        >
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              <p className="text-white/60 text-sm">{walletId}</p>
              {/* Wallet Type Badge */}
              <Badge 
                className={`${
                  type === 'team' 
        ...
        >
          <div className="text-center">
            ...
            >
              ...
              <h1 className="text-white text-7xl mb-2">{totalValueUSDC}</h1>
            ...
            >
              <p className="text-white text-sm">Double tap to appreciate ❤️</p>
            </motion.div>
        ...
        >
          ...
          {/* Stats Grid - Only Total Value and Last Activity */}
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4">
              ...
              <p className="text-emerald-400 text-xl">{totalValueUSDC} USDC</p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4">
              ...
              <p className="text-white text-xl">{lastActivity}</p>
            </div>
          </div>
        </motion.div>
      </div>
